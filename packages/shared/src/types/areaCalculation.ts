export enum AreaCalculationStatus {
  Pending = 'pending',
...
export interface CoordinatePoint {
  nokta_no?: string | number | null;
  point_no?: string | number | null;
...
export interface DedicationInfo {
  ...
  edge_length_m?: number | string | null;
  edge?: string | null;
  kenar?: string | null;
  amount_m?: number | string | null;
  miktar_m?: number | string | null;
  type?: string | null;
  tip?: string | null;
  [key: string]: unknown;
}
...
export interface ExtractedData {
  document_type: 'rolovesi' | 'eimar' | 'plan_notes' | 'combined' | string;
  parcel: {
...
export interface AreaCalculation {
  id: string;
  projectId: string;
  status: AreaCalculationStatus | string;
